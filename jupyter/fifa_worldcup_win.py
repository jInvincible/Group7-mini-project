...
ff_details = pd.read_excel('Fifa_world_cup_raw3.xlsx', sheet_name='Match Details')
...
# change dtype of the 2 columns above to 'int64'
...
ax.set_title(label='Top 10 Countries of Win Rate of WorldCup')
...
# add a line
ax.axvline(x=50, ls=':', color = 'white', ymin=0.05, ymax=0.95)
ax.set_title(label='Win Rate of WorldCup by Region')
...
plt.title('Correlation of Win Rate and others', fontsize = 22)
plt.show()
print(df_team_info_percent_corr)

# %%
- Top 10 Countries of Win Rate of WorldCup
- Win Rate of WorldCup by Region
- Participants of Semi-finals and Finals
- Top 10 Countries of Average Goal
- Top 10 Countries with Discipline cards
- Correlation of Win Rate and others